...
Footer.defaultProps = {
  rootClassName: '',
  heading: 'SH',
  text: 'Контакты: admin@mail.ru | +7-(999)-888-77-66 | admin panel | refresh leaderboard',
}
