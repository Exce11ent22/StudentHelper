...
const UserHeader = (props) => {
  return (
    ...
    >
      ...
      <div data-type="BurgerMenu" className="user-header-burger-menu">
      ...
      <div data-type="MobileMenu" className="user-header-mobile-menu">
        <nav className="user-header-nav1">
          <div className="user-header-container1">
            ...
            <div
              ...
              className="user-header-close-mobile-menu"
            >
              <svg viewBox="0 0 1024 1024" className="user-header-icon02">
                <path
