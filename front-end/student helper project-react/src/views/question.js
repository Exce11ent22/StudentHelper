      ...
      <div className="question-container1">
        <div className="question-container2">
          <div className="question-raiting">
            ...
            <svg viewBox="0 0 1024 1024" className="question-icon02">
        ...
        <div className="question-question">
          ...
          <div className="question-files">
            <div className="question-container4">
              <svg viewBox="0 0 1024 1024" className="question-icon04">
            ...
            <div className="question-container5">
              <svg viewBox="0 0 1024 1024" className="question-icon06">
                <path d="M554 384h236l-236-234v234zM256 86h342l256 256v512q0 34-26 59t-60 25h-512q-34 0-60-25t-26-59l2-684q0-34 25-59t59-25z"></path>
              </svg>
              <a
                href="https://example.com"
          ...
          <div className="question-leave-comment">
            ...
            ></textarea>
            <div className="question-container6">
            ...
            <div className="question-files1">
              <div className="question-container7">
                <svg viewBox="0 0 1024 1024" className="question-icon08">
                  <path d="M554 384h236l-236-234v234zM256 86h342l256 256v512q0 34-26 59t-60 25h-512q-34 0-60-25t-26-59l2-684q0-34 25-59t59-25z"></path>
                </svg>
                <a
                  href="https://example.com"
              ...
              <div className="question-container8">
                <svg viewBox="0 0 1024 1024" className="question-icon10">
                  <path d="M554 384h236l-236-234v234zM256 86h342l256 256v512q0 34-26 59t-60 25h-512q-34 0-60-25t-26-59l2-684q0-34 25-59t59-25z"></path>
                </svg>
                <a
                  href="https://example.com"
